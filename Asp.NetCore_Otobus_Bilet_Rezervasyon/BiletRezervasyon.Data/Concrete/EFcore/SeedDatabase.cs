...
namespace BiletRezervasyon.Data.Concrete.EFcore
{
    public static class SeedDatabase
    {
        ...
        {
            new Route() {RouteId=1,FirstTerminal="Adana",Terminal1="Konya" ,Terminal2="Balıkesir",LastTerminal="Ankara", Date="14.05.2022", Hour="12:00",Price=100,BusId=1},
            new Route() {RouteId=2,FirstTerminal="Ankara",Terminal1="Bursa" ,Terminal2="Balıkesir",Terminal3="Ağrı",Terminal4="Kastamonu", Terminal5="Malatya", LastTerminal="Bilecik", Date="14.05.2022", Hour="10:00",Price=150,BusId=2},
            new Route() {RouteId=3,FirstTerminal="Bilecik",Terminal1="Burdur" ,Terminal2="Balıkesir",Terminal3="Muğla",Terminal4="Antalya", LastTerminal="Bursa", Date="14.05.2022", Hour="18:00",Price=200,BusId=3},
            ...
            new Route() {RouteId=5,FirstTerminal="Denizli",Terminal1="İzmir" ,Terminal2="Balıkesir",Terminal3="Konya", LastTerminal="Eskişehir", Date="14.05.2022", Hour="16:00",Price=300,BusId=5},
            new Route() {RouteId=6,FirstTerminal="Eskişehir",Terminal1="Burdur" ,Terminal2="Balıkesir",Terminal3="Düzce",Terminal4="Osmaniye", Terminal5="Karabük", LastTerminal="Hatay", Date="14.05.2022", Hour="15:00",Price=350,BusId=6}
